...
import static com.answer.enums.Data.ACCOUNT_NAME;
...
public class WatchPage extends BaseSteps {
 ...
 // final String prod1= "//a[@href='?add_to_wishlist=14']";
  ...
  final String prod1= "//*[@data-product-id='14']";
  final String prod2="//*[@data-product-id='12']";
  final String prod3= "//*[@data-product-id='13']";
