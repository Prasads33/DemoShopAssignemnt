...
public class womensClothing extends BaseSteps {
 ...
 // final String prod1= "//a[@href='?add_to_wishlist=14']";
  ...
  final String prod1= "//*[@data-product-id='24']";
 // final String prod2="//*[@data-product-id='12']";
  ...
  public womensClothing(WebDriver driver, WebDriverWait wait) {
    this.driver = driver;
    this.wait = wait;
...
public void SelectProd(String prodCate, int quantity) {
   ...
   System.out.println("---quantityprasad--"+quantity);
System.out.println("---Xpathl1--"+l1);
